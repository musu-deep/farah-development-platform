    ...
    <footer className="grain overflow-hidden bg-ink pb-9 pt-20 text-white" data-testid="footer">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
        <div className="grid gap-12 border-b border-white/10 pb-14 md:grid-cols-12">
          <div className="md:col-span-6"><Logo dark /><p className="mt-6 max-w-xl leading-8 text-white/48">بيت خبرة سعودي يبني حلولاً إدارية وتنموية قابلة للقياس، ويحوّل الاستراتيجية إلى قدرة مؤسسية ونتائج مستدامة.</p></div>
